...
uses
  ActiveX,Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants,
  System.Classes, Vcl.Graphics,
  Xml.xmldom, Xml.XMLIntf, Xml.Win.msxmldom, Xml.XMLDoc, Vcl.StdCtrls, debug_Unit,
  Utils_Unit;
...
begin
  ...
  debug((Sender as TObject).ClassName);
